    ...
    <div class="main d-flex flex-column justify-content-between">
        <nav class="navbar navbar-dark navbar-expand-lg bg-success">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Arsip Kepegawaian</a>
                    ...
                    @if (Auth::user())
                        @if (Auth::user()->role_id == 1)
                            <a href="/dashboard" @if (request()->route()->uri == 'dashboard') class='active'
                                @endif>Dashboard </a>
                            <a href="/arsips" @if (request()->route()->uri == 'arsips' || request()->route()->uri == 'arsip-add' || request()->route()->uri == 'arsip-deleted' || request()->route()->uri == 'arsip-edit/{slug}' || request()->route()->uri == 'arsip-delete/{slug}') class='active'
                                @endif>Arsips </a>
                            ...
                            <a href="/" @if (request()->route()->uri == '/') class='active'
                                @endif>Book List</a>
                            <a href="/arsip-rent" @if (request()->route()->uri == 'arsip-rent') class='active'
                                @endif>Arsip Rent</a>
